...
import org.openjsse.legacy8ujsse.sun.security.validator.*;
import sun.security.util.HostnameChecker;

/**
 * This class implements the Legacy8uJSSE X.509 trust manager using the internal
...
final class X509TrustManagerImpl extends X509ExtendedTrustManager
    ...
    private void checkTrusted(X509Certificate[] chain,
        ...
        if ((socket != null) && socket.isConnected() &&
            ...
            trustedChain = validate(v, chain, constraints,
            ...
            trustedChain = validate(v, chain, null,
                                    checkClientTrusted ? null : authType);
        }
