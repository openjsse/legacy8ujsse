...
import static org.openjsse.legacy8ujsse.sun.security.ssl.CipherSuite.KeyExchange.*;
import static org.openjsse.legacy8ujsse.sun.security.ssl.CipherSuite.PRF.*;
import static org.openjsse.legacy8ujsse.sun.security.ssl.CipherSuite.CipherType.*;
import static org.openjsse.legacy8ujsse.sun.security.ssl.JsseJce.*;
...
final class CipherSuite implements Comparable<CipherSuite> {
    ...
    static {
        ...
        final boolean N = (Legacy8uJSSE.isFIPS() == false);
