...
import static org.openjsse.legacy8ujsse.sun.security.ssl.Legacy8uJSSE.cryptoProvider;
...
final class JsseJce {
    ...
    private static final class SunCertificates extends Provider {
        ...
        SunCertificates(final Provider p) {
            super("SunCertificates", 1.8d, "Legacy8uJSSE internal");
    ...
    static Signature getSignature(String algorithm)
        ...
        if (cryptoProvider == null) {
            ...
            if (algorithm == SIGNATURE_SSLRSA) {
                ...
                // the Legacy8uJSSE implementation does the actual crypto using
